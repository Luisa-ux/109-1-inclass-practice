...
將courses107每個科目應修系級拆成vector of characters, course107有2523門科目，所以拆完後是list of 2523，存在**forMajors**物件裡 每個系級是一個元素值。，

  * forMajors: list of 2523 elements, 每個元素值是個character vector。[0.15]
  
請計算**forMajors**每個元素值有多少個系級，並存在**n_appliedMajors**。

  * n_appliedMajors: an integer class vector of 2523 elements。[0.2]
